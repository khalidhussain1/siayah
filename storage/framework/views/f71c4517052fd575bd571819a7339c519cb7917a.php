  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?php echo e(route('admin.index')); ?>">
        <!-- <img src="<?php echo e(asset('img/logo-ct.png')); ?>" class="navbar-brand-img h-100" alt="main_logo"> -->
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white bg-gradient-primary" href="<?php echo e(route('admin.index')); ?>">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php echo e((request()->is('admin/onewaybookingdetails*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.onewaybooking')); ?> ">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php echo e((request()->is('admin/bookingdetails*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.bookingdetails')); ?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php echo e((request()->is('admin/hotels*')) ? 'active' : ''); ?> " href="<?php echo e(url('admin/hotels')); ?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php echo e((request()->is('admin/history*')) ? 'active' : ''); ?>" href="<?php echo e(url('admin/history')); ?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">view_in_ar</i>
            </div>
  ...
  </aside><?php /**PATH H:\xampp\htdocs\siayah\resources\views/admin/layout/sidebar.blade.php ENDPATH**/ ?>