                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column
                              justify-content-center">
                              <p class="mb-0 text-sm">{{$item->package_title}}</p>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column
                              justify-content-center">
                              <p class="mb-0 text-sm">{{$item->hotel->name}}</p>
                            </div>
                          </div>
                        </td>
                        <td>
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column
                              justify-content-center">
                              <p class="mb-0 text-sm">{{$item->nights}}</p>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column
                              justify-content-center">
                                    ...
                                    height: 20px;
                                    width: 52px;
                                    font-size: 12px;"><a href="{{ route('admin.viewpackage', ['id'=>$item->id]) }}" style="color:white;text-decoration:none">View </a></button>
                                          </div>
